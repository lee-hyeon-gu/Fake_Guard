...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_txt_dir', type=str,default='/home/alpaco/REAL_LAST/TALL4Deepfake', help='path to text of dataset')
...
# create data loaders w/ augmentation pipeiine
    ...
    from video_dataset import VideoDataSetOnline
